...
Of particular interest was that the SVM setting did not predict any draws at all. This may have been because our SVM relied on a one-vs-one method for multiclass method.
